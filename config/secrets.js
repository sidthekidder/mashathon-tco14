...
module.exports = {
  ...
  db: process.env.MONGOLAB_URI || process.env.MONGODB || '<its in the uri>',

  sessionSecret: process.env.SESSION_SECRET || 'Your Session Secret goes here',

  facebook: {
    clientID: process.env.FACEBOOK_ID || '694329333946945',
    clientSecret: process.env.FACEBOOK_SECRET || '088e30c5cce903a8cfc8d744bb013722',
